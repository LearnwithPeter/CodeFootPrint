              ...
              >
                ...
                <span
                  className={`absolute bottom-0 left-0 h-0.5 transition-all duration-300 ${
                    location.pathname === link.to
                      ? "w-full bg-gradient-to-r from-[#00D4FF] to-[#00FF88]"
          ...
          <div className="border-t border-[#1E2A3A] bg-[#0D1117]/95 backdrop-blur-xl">
            <div className="max-w-7xl mx-auto px-6 py-4 flex gap-3 items-center">
              <div className="flex-1 relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 font-mono text-[#00D4FF] text-sm">
                  ~/
                </span>
                <input
                  type="text"
              ...
              <button
                onClick={() => setShowAnalyzeBar(false)}
                className="text-[#4A5568] hover:text-[#718096]"
              >
                <X size={18} />
              </button>
            </div>
